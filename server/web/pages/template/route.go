...
func RouteWebPages(route *gin.RouterGroup) {
	...
	route.GET("/static/js/2.05d7e1cd.chunk.js", func(c *gin.Context) {
		etag := fmt.Sprintf("%x", md5.Sum(Staticjs205d7e1cdchunkjs))
		c.Header("Cache-Control", "public, max-age=31536000")
		c.Header("ETag", etag)
		c.Data(200, "text/javascript; charset=utf-8", Staticjs205d7e1cdchunkjs)
	})

	route.GET("/static/js/2.05d7e1cd.chunk.js.LICENSE.txt", func(c *gin.Context) {
		etag := fmt.Sprintf("%x", md5.Sum(Staticjs205d7e1cdchunkjsLICENSEtxt))
		c.Header("Cache-Control", "public, max-age=31536000")
		c.Header("ETag", etag)
		c.Data(200, "text/plain; charset=utf-8", Staticjs205d7e1cdchunkjsLICENSEtxt)
	})

	route.GET("/static/js/2.05d7e1cd.chunk.js.map", func(c *gin.Context) {
		etag := fmt.Sprintf("%x", md5.Sum(Staticjs205d7e1cdchunkjsmap))
		c.Header("Cache-Control", "public, max-age=31536000")
		c.Header("ETag", etag)
		c.Data(200, "application/json", Staticjs205d7e1cdchunkjsmap)
	})

	route.GET("/static/js/main.7ed3a6c0.chunk.js", func(c *gin.Context) {
		etag := fmt.Sprintf("%x", md5.Sum(Staticjsmain7ed3a6c0chunkjs))
		c.Header("Cache-Control", "public, max-age=31536000")
		c.Header("ETag", etag)
		c.Data(200, "text/javascript; charset=utf-8", Staticjsmain7ed3a6c0chunkjs)
	})

	route.GET("/static/js/main.7ed3a6c0.chunk.js.map", func(c *gin.Context) {
		etag := fmt.Sprintf("%x", md5.Sum(Staticjsmain7ed3a6c0chunkjsmap))
		c.Header("Cache-Control", "public, max-age=31536000")
		c.Header("ETag", etag)
		c.Data(200, "application/json", Staticjsmain7ed3a6c0chunkjsmap)
	})
